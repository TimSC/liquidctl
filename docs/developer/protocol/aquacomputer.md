...
fan curve mode on the Octo and Quadro. When programming a fan curve,
`--temperature-sensor` updates the source sensor selection; otherwise liquidctl
leaves the existing source sensor selection untouched.
